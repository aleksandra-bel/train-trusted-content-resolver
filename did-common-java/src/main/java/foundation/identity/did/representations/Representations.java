...
public class Representations {
    ...
    public static final String MEDIA_TYPE_DID = "application/did";
    ...
    static {
        ...
        didDocumentConsumers.put(RepresentationConsumerDID.getInstance().getMediaType(), RepresentationConsumerDID.getInstance());
    }
    ...
    public static RepresentationConsumer getConsumer(String mediaType) {
        ...
        return didDocumentConsumers.get(normalized);
    }
}
